#!/bin/bash
# Fix the Picolibc build issues

cd /home/noneya/code/dons-os-x86_64/04_kernel_64bit/userland

# Fix stdio_init.c with proper externs
cat > picolibc/stdio_init.c << 'EOF'
